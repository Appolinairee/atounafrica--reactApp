  ...
  return (
    <div className="max-w-[360px] rounded-xl m-auto px-4 bg-gradient-green-yellow z-30 py-[4rem] pb-20 xs:px-5">
        <div className="flex flex-wrap justify-between w-full">
          <div className="">
              <h3 className="text-3xl font-bold xs:text-[1.7rem]">Inscription</h3>
          ...
          <div className="z-0">
              <img className="w-full h-full max-w-[150px] translate-y-8" src={SignImage} alt="Inscription" />
          </div>
        </div>
        ...
        <div className="w-full mt-4">
          <form className="z-10" action="" method="post">
              ...
              <div className="bg-red px-3 py-2 flex items-center justify-center relative bg-light text-dark rounded-[8px] mb-2">
                  ...
                  <input className="pl-6 w-full" type="text" placeholder="Nom d'utilisateur" required/>
              </div>
              ...
              <div className="bg-red px-3 py-2 flex items-center justify-center relative bg-light text-dark rounded-[8px] mb-2">
                  ...
                  <input className="pl-6 w-full" type={`${password ? 'text' : 'password'}`} placeholder="Confirmation..." required />
              </div>
              ...
              <div className="bg-red px-3 py-2 flex items-center justify-center relative bg-primary text-dark rounded-[8px] mt-3 mb-2 text-center cursor-pointer">
                  <button type="submit" className="text-center font-semibold align-middle w-full text-light">S'Inscrire</button>
              </div>
          </form>
        </div>
        ...
        <div className="my-8 w-full">
          <p className="text-[14px] text-dark/70 my-3 text-center">Ou s'inscrire avec</p>
        ...
        <div className="mb-2 text-[15px] w-full text-center">
            <p>Avez-vous un compte ? <Link className=" underline text-primary font-medium" to="/connexion">Se connecter.</Link></p>
        </div>
    </div>
  )
}
