  ...
  reducers: {
    ...
    updateOrders: (state, action) => {
      ...
      if (existingOrderIndex !== -1) {
        state.orders[existingOrderIndex] = { ...state.orders[existingOrderIndex], ...updatedOrder };
      } else {
...
export const { setOrders, setLoading, setError, updateOrders } = ordersSlice.actions;
