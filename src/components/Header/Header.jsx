      ...
      <header className="topSection">
         <div className="headerMain section">
            <h1 className="text-4xl">
               ...
               pour tous vos besoins et services.
            </h1>
                     ...
                     <div className="product">
                        ...
                        <div className="productInfos">
                           <p className="productName">
                              King of Soto: La liqueur rafraichissante
                           </p>
         ...
         <div className="sideBar">
            <div className="categories flex section">
               <p className="categoriesTitle">Parcourez nos catégories</p>

               {Categories.map((category, index) => (
                  <div
                     key={index}
                     className={
                        index === 0 ? "category flex active" : "category flex"
                     }
                  >
               ...
               <a href="#" className="seeAll before">
                  Tout
               </a>
            </div>
            ...
            <div className="sloganSection">
               ...
               <div className="sloganText flex">
                  <span>
                     Sois Africain <br /> Sois Authentique
                  </span>
