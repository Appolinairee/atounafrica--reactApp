...
const ChatForm = () => {
    return(
      <div className="absolute w-[98%] left-[0px] h-[50px] bg-transparent bottom-1.5 z-10">
            ...
            <form action="" method="post" className="flex flex-nowrap h-full relative gap-1 ">
              <div className="shadow-boxShadow1 w-[90%] flex relative items-center ml-[2%] rounded-[20px] bg-light">
                ...
                <input type="text" name="message" placeholder="Message" className="rounded-[20px] w-full bg-light pl-8 py-2 text-dark text-[14px]" autoFocus/>
              </div>
